  ...
  return (
    <section className='w-full flex xl:flex-row flex-col items-start justify-center lg:mt-40 mt-20 mb-20 relative sm:px-16 px-4 xl:gap-0 gap-8'>
        <div className='flex flex-col xl:gap-6 gap-4 xl:items-start xl:justify-start justify-center items-center xl:max-w-[40rem] w-full xl:text-left text-center'>
            <h1 className='font-atyp-display text-4xl 2xl:text-5xl font-normal leading-tight'>Stocks & Bonds <span className='whitespace-nowrap'>On-Chain</span></h1>
            <p className='text-foreground-leading leading-normal text-base 2xl:text-lg xl:max-w-none sm:max-w-[38rem]'>{"Each token is backed by financial assets, providing a secure and compliant way to access to TradFi via crypto."}</p>
        </div>
        <div className='relative flex flex-col xl:items-end items-center xl:justify-end justify-center w-full xl:gap-0 gap-4'>
            ...
            <TokenCard className='z-40 xl:mr-64 xl:flex absolute top-auto xl:-top-12' name='Treasury Bond 0-1yr UCITS ETF' ticker='IB01' icon={ib01Icon} bgEffect={ib01Effect}></TokenCard>
        </div>
        <span
