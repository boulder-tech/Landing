  ...
  return (
    <div className="mt-32 mb-48 h-full flex flex-col items-center justify-center gap-10 relative 2xl:px-[200px] lg:px-[150px] md:px-[75px] px-[20px]">
      ...
      <div className="flex flex-wrap justify-center gap-8">
        <PersonCard
          name="Ariel Schapira"
          imageRoute="/assets/team/ariel.png"
          fact1="Industrial Engineer & businessman with a"
          fact1col="long professional career"
          fact2="Key Executive leading"
          fact2col="Telecommunications, Energy & Insurance companies"
        />
        <PersonCard
          name="Gabriel Cohen"
        ...
        <PersonCard
          ...
          fact1="+24y Working for"
          fact1col="MercadoLibre"
          fact2="VP Marketplace"
          fact2col="VIS MELI"
          fact3="Actual"
          fact3col="Advisor & mentor"
        />
        <PersonCard
          name="Evan Van Ness"
