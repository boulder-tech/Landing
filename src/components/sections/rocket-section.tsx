...
const RocketSection = () => {
    return (
        <>
            <section className="w-full flex items-center justify-center my-40 sm:mb-60 mb-20 overflow-hidden px-8">
                <div className="bg-card-dark flex items-center justify-start rounded-xl z-20 border border-[#fafbff12] 3xl:py-20 sm:py-16 3xl:px-32 lg:px-20 sm:px-8 p-10 3xl:w-[65%] lg:w-[70%] w-full">
