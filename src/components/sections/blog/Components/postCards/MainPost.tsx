            ...
            <div className='flex flex-col gap-4'>
                ...
                <div className='flex flex-col gap-4'>
                    <div className='flex flex-col gap-1'>
                        ...
                        <h2 className='text-foreground-heading min-h-12 text-[1.75rem] font-atyp-display font-medium leading-[120%] group-hover:underline'>{title}</h2>
                    </div>
                    <p className='text-foreground-leading text-base'>In the ever-evolving domain of digital finance, 2024 marks a pivotal year with BoulderTech at the forefront, pioneering an innovative niche — the tokenization of Rea... n the ever-evolving domain of digital finance, 202...</p>
                </div>
            </div>
