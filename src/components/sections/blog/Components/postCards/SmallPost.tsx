            ...
            <div className='flex flex-col justify-between w-full'>
                <div className='flex flex-col gap-2'>
                    <div className='flex flex-col gap-0'>
                        ...
                        <h2 className='text-foreground-heading text-[1.625rem] font-atyp-display font-medium leading-[120%] group-hover:underline'>{title}</h2>
                    </div>
                    <p className=''>Greetings to the Global Blockchain Community, Welcome to the inag...</p>
                </div>
