  ...
  return (
    <header className="w-full fixed top-0 z-50 py-3 bg-[rgba(1, 3, 18, 0.01)] border-b border-grey-200 backdrop-blur-lg">
      <div className="flex items-center justify-between 2xl:px-[300px] lg:px-[150px] md:px-[75px] px-[20px]">
        <div className="flex gap-4 divide-border-grey-200 divide-x-[1px]">
          <Imagotype />
          <div className="pl-4 text-boulder-text sm:flex hidden text-sm gap-4 font-normal -tracking-[0.28px]">
            <Link className="cursor-pointer hover:text-foreground-leading transition-all duration-200 font-medium" href={"/about"}>
              About
            </Link>
            <Link className="cursor-pointer hover:text-foreground-leading transition-all duration-200 font-medium" href={"/contact"}>
              Contact
            </Link>
            <Link
              className="cursor-pointer hover:text-foreground-leading transition-all duration-200 font-medium"
